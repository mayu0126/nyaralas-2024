            ...
            <div className={`${isNarrowScreen ? `w-11/12` : `w-1/3 px-4`} mb-5 flex flex-col xl:px-6 2xl:px-8 3xl:px-10`}>
              <div className='h-56 rounded-2xl overflow-hidden relative group'>
                <a href="https://www.booking.com/hotel/hr/villa-cube-premantura.hu.html">
                  <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/283963021.jpg?k=202a970f8414c4201f6471fed6f8a77b4f9d11950a76525efcc272cc66e38fb9&o=&hp=1" alt="szallas-1" className="w-full h-full object-cover" />
            ...
            <div className={`${isNarrowScreen ? `w-11/12` : `w-1/3 px-4`} mb-5 flex flex-col xl:px-6 2xl:px-8 3xl:px-10`}>
              <div className='h-56 rounded-2xl overflow-hidden relative group'>
                <a href="https://www.facebook.com/AzurEtterem/?locale=hu_HU">
                  <img src="https://i.imgur.com/EcWUcWx.jpg" alt="szallas-2" className="w-full h-full object-cover"/>
                  <div className="absolute inset-0 bg-white opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-30"></div>
                </a>
              </div>
            ...
            <div className={`${isNarrowScreen ? `w-11/12` : `w-1/3 px-4`} mb-5 flex flex-col xl:px-6 2xl:px-8 3xl:px-10`}>
              <div className='h-56 rounded-2xl overflow-hidden relative group'>
                <a href="https://www.booking.com/hotel/hu/szoloskert-fogado.hu.html">
                  <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/109175543.jpg?k=abbbd31b99aadb8b8443aae6b88ad815f0910ff4ea6f66cf5178d09d0a6f081f&o=&hp=1" alt="szallas-3" className="w-full h-full object-cover"/>
                  <div className="absolute inset-0 bg-white opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-30"></div>
                </a>
              </div>
